...
DataStructDef.data.role_info = 
{
	...
	[13] = {id=13, field='attr_byte', type=_Byte, save=1, default='0'},
	[14] = {id=14, field='attr_bool', type=_Bool, save=1, default='1'},
	[15] = {id=15, field='attr_int', type=_Int, save=1, default='0'},
	[16] = {id=16, field='attr_float', type=_Float, save=1, default='0'},
	[17] = {id=17, field='attr_short', type=_Short, save=1, default='0'},
	[18] = {id=18, field='attr_int64', type=_Int64, save=1, default='0'},
	[19] = {id=19, field='attr_string', type=_String, save=1, default=''},
	[20] = {id=20, field='attr_struct', type=_Struct, save=1, default='{}'},
}
